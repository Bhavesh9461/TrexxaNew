    ...
    const result = await Sentry.startSpan(
      ...
      async (span) => {
        const out = await generateImage({
          ...
          providerOptions: {
            openai: {
              input_fidelity: "high", // this means that the input image is used as a redference for the generation
        ...
        if (u.inputTokens != null) {
          span.setAttribute("get_ai.usage.input_tokens", u.inputTokens);
        }
